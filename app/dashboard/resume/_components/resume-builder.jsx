...
export default function ResumeBuilder({ initialContent }) {
        ...
        if (user) {
            ...
            try {
                const existingResume = await db.query.Resume.findFirst({
                    where: eq(Resume.userEmail, emailAddress),
                });
    ...
    const generatePDF = async () => {
        ...
        try {
            ...
            if (!element) {
                toast.error("No content available to generate the PDF. Please add some details before downloading.if content available go to markdown and download");
    ...
    return (
        <div data-color-mode="light" className="space-y-4 pt-28 ">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-2">
                <h1 className="font-bold gradient-title text-xl md:text-2xl">
                    Resume Builder
                </h1>
